...
import 'package:travel_app/widgets/amenities_widget.dart';
import 'package:travel_app/widgets/confirm_button_widget.dart';
import 'package:travel_app/widgets/frosted_widget.dart';
import 'package:travel_app/widgets/rooms_image_widget.dart';

class DestinationDetailsPage extends StatelessWidget {
  final String imageName;
  final String tag;
  const DestinationDetailsPage(
      {required this.tag, required this.imageName, super.key});
    ...
    return Row(
      ...
      children: [
        ...
        Container(
          ...
          width: 70,
          decoration: BoxDecoration(
            color: Colors.grey.shade200.withValues(alpha: .8),
